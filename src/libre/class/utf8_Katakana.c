...
utf8_Katakana_fsm(const struct fsm_options *opt)
{
	...
	if (!fsm_addedge_literal(fsm, s[2], s[6], 0xbd)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[2], s[7], 0xbe)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[3], s[4], 0x9b)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[4], s[5], 0x80)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[5], s[8], 0x80)) { goto error; }
	for (i = 0xa6; i <= 0xaf; i++) {
