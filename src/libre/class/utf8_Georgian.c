...
utf8_Georgian_fsm(const struct fsm_options *opt)
{
	...
	if (!fsm_addedge_literal(fsm, s[1], s[3], 0x82)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[1], s[4], 0x83)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[2], s[5], 0xb4)) { goto error; }
	for (i = 0xa0; i <= 0xbf; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[4], s[6], 0x87)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[4], s[6], 0x8d)) { goto error; }
	for (i = 0x90; i <= 0xba; i++) {
		if (!fsm_addedge_literal(fsm, s[4], s[6], i)) { goto error; }
	}
	for (i = 0xbc; i <= 0xbf; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[5], s[6], 0xa7)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[5], s[6], 0xad)) { goto error; }
