...
struct fsm *
utf8_Myanmar_fsm(const struct fsm_options *opt)
{
	struct fsm *fsm;
	size_t i;
	...
	if (!fsm_addedge_literal(fsm, s[1], s[7], 0x82)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[2], s[3], 0xa7)) { goto error; }
	if (!fsm_addedge_literal(fsm, s[2], s[4], 0xa9)) { goto error; }
	for (i = 0xa0; i <= 0xbe; i++) {
